        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex justify-start items-center">
              ...
              <a href={"https://flowbite.com"} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between mr-4">
                <img
                  src="https://flowbite.s3.amazonaws.com/logo.svg"
                  className="mr-3 h-8"
                  alt="Logo Aplikasi"
                  onError="this.onerror=null;this.src='https://placehold.co/80x80/007bff/ffffff?text=BS'"
                />
            ...
            <div className="flex items-center lg:order-2">
              ...
              >
                ...
                <img
                  ...
                  src="https://placehold.co/80x80/007bff/ffffff?text=AD"
                  alt="user photo"
                />
              </button>
          ...
          <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            <ul className="space-y-2">
              ...
              <li className="pt-5 mt-5 border-t border-gray-200 dark:border-gray-700">
                <span className="block py-2 px-4 text-xs font-semibold text-gray-500 uppercase dark:text-gray-400">Data Master</span>
              </li>
              ...
              <li className="pt-5 mt-5 border-t border-gray-200 dark:border-gray-700">
                <span className="block py-2 px-4 text-xs font-semibold text-gray-500 uppercase dark:text-gray-400">Transaksi</span>
              </li>
              <li>
              ...
              <li className="pt-5 mt-5 border-t border-gray-200 dark:border-gray-700">
                <button
                  onClick={handleLogout}
                  className="w-full flex items-center p-2 text-base font-medium text-red-900 rounded-lg transition duration-75 hover:bg-red-100 bg-red-200 dark:hover:bg-red-700 dark:text-white group"
                >
