                ...
                {authors.length > 0 ? (
                  authors.map((author) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">{author.biodata}</td>
                      <td className="px-4 py-3">{author.created_at}</td>
                      <td className="px-4 py-3">{author.updated_at}</td>
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        <button
                          id={"dropdown_button-${author.id}"}
                        ...
                        {openDropdownId === author.id && (
                          ...
                          >
                            <ul
                              ...
                              aria-labelledby={"dropdown_button-${author.id}"}
                            >
                              <li>
                                <Link
