                ...
                {genres.length > 0 ? (
                  genres.map((genre) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">{genre.created_at}</td>
                      <td className="px-4 py-3">{genre.updated_at}</td>
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        <button
                          id={"dropdown_button-${genre.id}"}
                        ...
                        {openDropdownId === genre.id && (
                          ...
                          >
                            <ul
                              ...
                              aria-labelledby={"dropdown_button-${genre.id}"}
                            >
                              <li>
                                <Link
